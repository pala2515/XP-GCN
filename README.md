...
Highlights
• A novel hybrid model, XP-GCN, strategically fuses a parallel GCN with an ELM.
• Fuses multi-scale graph features and molecular fingerprints for robust prediction.
• Achieves state-of-the-art 98.46 % ROC-AUC for BBBP prediction
• An ELM classifier enables high-throughput, backpropagation-free prediction.
• Achieves over 95 % performance on classification tasks at the microsecond level.
